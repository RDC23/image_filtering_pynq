...
proc create_root_design { parentCell } {
  ...
  set filter_0 [ create_bd_cell -type ip -vlnv strath.ac.uk:SysGen:filter:1.0 filter_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins filter_0/s_axis]
  ...
  connect_bd_intf_net -intf_net filter_0_m_axis [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins filter_0/m_axis]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs filter_0/filter_s_axi/reg0] -force
