...
HD_PWD='C:/Users/dsb21132/project_simple_add/project_simple_add.runs/design_1_simple_add_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_simple_add_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_simple_add_0_0.tcl
