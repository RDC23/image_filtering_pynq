...
architecture structural of general_filter_subsystem is 
  ...
  signal ce_net : std_logic;
  signal addsub_s_net : std_logic_vector( 25-1 downto 0 );
  signal addsub2_s_net : std_logic_vector( 27-1 downto 0 );
  signal addsub3_s_net : std_logic_vector( 28-1 downto 0 );
  signal clk_net : std_logic;
  signal addsub1_s_net : std_logic_vector( 26-1 downto 0 );
  ...
  signal addsub4_s_net : std_logic_vector( 29-1 downto 0 );
  signal delay_q_net : std_logic_vector( 28-1 downto 0 );
  ...
  signal addsub6_s_net : std_logic_vector( 31-1 downto 0 );
  signal delay4_q_net : std_logic_vector( 24-1 downto 0 );
  signal mult9_p_net : std_logic_vector( 32-1 downto 0 );
  signal divide1_op_net : std_logic_vector( 20-1 downto 0 );
...
begin
  ...
  divide1 : entity xil_defaultlib.xldivider_generator_f9fb9d1770799ba32c2787e8b3661092 
  port map (
    a_tvalid => '1',
    b_tvalid => '1',
    a => constant10_op_net,
